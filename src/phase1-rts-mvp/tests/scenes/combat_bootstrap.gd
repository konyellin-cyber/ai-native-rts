...
func _get_config_path() -> String:
	...
	## 通过脚本路径推导：res://tests/scenes/<name>/bootstrap.gd → res://tests/scenes/<name>/config.json
	var script_path: String = get_script().resource_path  # e.g. res://tests/scenes/smoke_test/bootstrap.gd
